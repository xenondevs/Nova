...
object NovaMaterialRegistry {
    ...
    val BASIC_CABLE = registerTileEntity("BASIC_CABLE", "block.nova.basic_cable", structureBlockOf(5100), null, structureBlockOf((5101..5164).toIntArray() + (5025..5033).toIntArray()), AIR, ::BasicCable, isDirectional = false, legacyItemIds = intArrayOf(5004))
    val ADVANCED_CABLE = registerTileEntity("ADVANCED_CABLE", "block.nova.advanced_cable", structureBlockOf(5165), null, structureBlockOf((5166..5229).toIntArray() + (5025..5033).toIntArray()), AIR, ::AdvancedCable, isDirectional = false, legacyItemIds = intArrayOf(5009))
    val ELITE_CABLE = registerTileEntity("ELITE_CABLE", "block.nova.elite_cable", structureBlockOf(5230), null, structureBlockOf((5231..5294).toIntArray() + (5025..5033).toIntArray()), AIR, ::EliteCable, isDirectional = false, legacyItemIds = intArrayOf(5014))
    val ULTIMATE_CABLE = registerTileEntity("ULTIMATE_CABLE", "block.nova.ultimate_cable", structureBlockOf(5295), null, structureBlockOf((5296..5359).toIntArray() + (5025..5033).toIntArray()), AIR, ::UltimateCable, isDirectional = false, legacyItemIds = intArrayOf(5019))
    val CREATIVE_CABLE = registerTileEntity("CREATIVE_CABLE", "block.nova.creative_cable", structureBlockOf(5360), null, structureBlockOf((5361..5424).toIntArray() + (5025..5033).toIntArray()), AIR, ::CreativeCable, isDirectional = false, legacyItemIds = intArrayOf(5024))
