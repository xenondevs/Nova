...
class Pump(
    ...
    override val energyHolder = ConsumerEnergyHolder(this, ENERGY_CAPACITY, ENERGY_PER_TICK, 0, upgradeHolder = upgradeHolder) { createExclusiveEnergySideConfig(EnergyConnectionType.CONSUME, BlockSide.BACK) }
    override val fluidHolder = NovaFluidHolder(this, fluidTank to NetworkConnectionType.EXTRACT, defaultConnectionConfig = { createSideConfig(NetworkConnectionType.EXTRACT) })
