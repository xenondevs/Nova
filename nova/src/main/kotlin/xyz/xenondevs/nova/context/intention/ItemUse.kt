 ...
 */
object ItemUse : AbstractContextIntention<ItemUse>() {
    
    /**
     * The [UUID] of the source of the item use.
     */
    val SOURCE_UUID = addOptionalParamType<UUID>()
    
    /**
     * The location of the source of the item use.
     */
    val SOURCE_LOCATION = addOptionalParamType(copy = Location::clone)
    
    /**
     * The eye location of the source of the item use.
     */
    val SOURCE_EYE_LOCATION = addOptionalParamType(copy = Location::clone)
    
    /**
     * The world of the source of the item use.
     */
    val SOURCE_WORLD = addOptionalParamType<World>()
    
    /**
     * The direction that the source of the item use is facing.
     */
    val SOURCE_DIRECTION = addOptionalParamType(copy = Vector::clone)
    
    /**
     * The entity that is the source of the item use.
     */
    val SOURCE_ENTITY = addOptionalParamType<Entity>()
    
    /**
     * The living entity that is the source of the item use.
     */
    val SOURCE_LIVING_ENTITY = addOptionalParamType<LivingEntity>()
    
    /**
     * The player that is the source of the item use.
     */
    val SOURCE_PLAYER = addOptionalParamType<Player>()
    
    /**
     * The [TileEntity] that is the source of the item use.
     */
    val SOURCE_TILE_ENTITY = addOptionalParamType<TileEntity>()
    
    /**
     * The player that either uses the item or is responsible for its use.
     */
