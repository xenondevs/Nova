...
internal object AutoCopyManager {
    ...
    var shouldCreateDirectories = false

    private var destinations: List<File>? = PermanentStorage.retrieve("copyToDestinations")
        set(value) {
            field = value
            PermanentStorage.store("copyToDestinations", value)
        }
