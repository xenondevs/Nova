...
private val MATERIAL_TEXTURES: Map<Material, String> = enumMapOf(
    ...
    Material.BAMBOO_DOOR to "item/bamboo_door",
    ...
    Material.FIREFLY_BUSH to "block/firefly_bush",
    Material.SHORT_DRY_GRASS to "block/short_dry_grass",
    Material.TALL_DRY_GRASS to "block/tall_dry_grass",
    ...
    Material.CACTUS_FLOWER to "block/cactus_flower",
    Material.WILDFLOWERS to "block/wildflowers",
    ...
    Material.COPPER_TORCH to "block/copper_torch",
    Material.LADDER to "block/ladder",
    Material.IRON_CHAIN to "item/iron_chain",
    Material.COPPER_CHAIN to "item/copper_chain",
    Material.EXPOSED_COPPER_CHAIN to "item/exposed_copper_chain",
    Material.WEATHERED_COPPER_CHAIN to "item/weathered_copper_chain",
    Material.OXIDIZED_COPPER_CHAIN to "item/oxidized_copper_chain",
    Material.WAXED_COPPER_CHAIN to "item/copper_chain",
    Material.WAXED_EXPOSED_COPPER_CHAIN to "item/exposed_copper_chain",
    Material.WAXED_WEATHERED_COPPER_CHAIN to "item/weathered_copper_chain",
    Material.WAXED_OXIDIZED_COPPER_CHAIN to "item/oxidized_copper_chain",
    Material.IRON_BARS to "block/iron_bars",
    Material.COPPER_BARS to "block/copper_bars",
    Material.EXPOSED_COPPER_BARS to "block/exposed_copper_bars",
    Material.WEATHERED_COPPER_BARS to "block/weathered_copper_bars",
    Material.OXIDIZED_COPPER_BARS to "block/oxidized_copper_bars",
    Material.WAXED_COPPER_BARS to "block/copper_bars",
    Material.WAXED_EXPOSED_COPPER_BARS to "block/exposed_copper_bars",
    Material.WAXED_WEATHERED_COPPER_BARS to "block/weathered_copper_bars",
    Material.WAXED_OXIDIZED_COPPER_BARS to "block/oxidized_copper_bars",
