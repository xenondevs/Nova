...
internal object PacketIdRegistry {
    ...
    val PLAY_SERVERBOUND_ATTACK = SERVERBOUND_PACKET_IDS.getInt(GamePacketTypes.SERVERBOUND_ATTACK)
    ...
    val PLAY_SERVERBOUND_CHANGE_GAME_MODE = SERVERBOUND_PACKET_IDS.getInt(GamePacketTypes.SERVERBOUND_CHANGE_GAME_MODE)
    ...
    val PLAY_SERVERBOUND_SET_GAME_RULE = SERVERBOUND_PACKET_IDS.getInt(GamePacketTypes.SERVERBOUND_SET_GAME_RULE)
    ...
    val PLAY_SERVERBOUND_SPECTATOR_ACTION = SERVERBOUND_PACKET_IDS.getInt(GamePacketTypes.SERVERBOUND_SPECTATOR_ACTION)
    ...
    val PLAY_SERVERBOUND_CUSTOM_CLICK_ACTION = SERVERBOUND_PACKET_IDS.getInt(CommonPacketTypes.SERVERBOUND_CUSTOM_CLICK_ACTION)
    ...
    val PLAY_CLIENTBOUND_DEBUG_BLOCK_VALUE = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_DEBUG_BLOCK_VALUE)
    val PLAY_CLIENTBOUND_DEBUG_CHUNK_VALUE = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_DEBUG_CHUNK_VALUE)
    val PLAY_CLIENTBOUND_DEBUG_ENTITY_VALUE = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_DEBUG_ENTITY_VALUE)
    val PLAY_CLIENTBOUND_DEBUG_EVENT = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_DEBUG_EVENT)
    ...
    val PLAY_CLIENTBOUND_GAME_RULE_VALUES = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_GAME_RULE_VALUES)
    val PLAY_CLIENTBOUND_GAME_TEST_HIGHLIGHT_POS = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_GAME_TEST_HIGHLIGHT_POS)
    ...
    val PLAY_CLIENTBOUND_LOW_DISK_SPACE_WARNING = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_LOW_DISK_SPACE_WARNING)
    ...
    val PLAY_CLIENTBOUND_WAYPOINT = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_WAYPOINT)
    val PLAY_CLIENTBOUND_CLEAR_DIALOG = CLIENTBOUND_PACKET_IDS.getInt(CommonPacketTypes.CLIENTBOUND_CLEAR_DIALOG)
    val PLAY_CLIENTBOUND_SHOW_DIALOG = CLIENTBOUND_PACKET_IDS.getInt(CommonPacketTypes.CLIENTBOUND_SHOW_DIALOG)
