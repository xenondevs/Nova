...
private val PACKET_SET_CLASS = Class.forName("net.minecraft.network.ConnectionProtocol\$PacketSet")
private val CODEC_DATA_PACKET_SET_GETTER = MethodHandles
    .privateLookupIn(CodecData::class.java, MethodHandles.lookup())
...
object PacketIdRegistry {
    ...
    private fun getPacketId(protocol: ConnectionProtocol, flow: PacketFlow, packet: KClass<*>): Int {
        val packetSet = CODEC_DATA_PACKET_SET_GETTER.invoke(protocol.codec(flow))
        return PACKET_SET_GET_ID_METHOD.invoke(packetSet, packet.java) as Int
    }
