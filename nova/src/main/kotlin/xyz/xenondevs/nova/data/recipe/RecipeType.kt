...
import xyz.xenondevs.nova.data.serialization.json.CookingRecipeDeserializer
...
class RecipeType<T : Any> internal constructor(
    ...
    companion object {
        ...
        val FURNACE = register("minecraft/furnace", FurnaceRecipe::class, SmeltingRecipeGroup, CookingRecipeDeserializer(::FurnaceRecipe))
        val BLAST_FURNACE = register("minecraft/blast_furnace", BlastingRecipe::class, BlastingRecipeGroup, CookingRecipeDeserializer(::BlastingRecipe))
        val SMOKER = register("minecraft/smoker", SmokingRecipe::class, SmokingRecipeGroup, CookingRecipeDeserializer(::SmokingRecipe))
        val CAMPFIRE = register("minecraft/campfire", CampfireRecipe::class, CampfireRecipeGroup, CookingRecipeDeserializer(::CampfireRecipe))
