...
internal object CbfSerializers {
    ...
    fun register() {
        ...
        Cbf.registerSerializer(Vector2dcBinarySerializer)
        Cbf.registerSerializer(Vector2fBinarySerializer)
        Cbf.registerSerializer(Vector2fcBinarySerializer)
        Cbf.registerSerializer(Vector3iBinarySerializer)
        Cbf.registerSerializer(Vector3icBinarySerializer)
        Cbf.registerSerializer(Vector3dBinarySerializer)
        Cbf.registerSerializer(Vector3dcBinarySerializer)
        Cbf.registerSerializer(Vector3fBinarySerializer)
        Cbf.registerSerializer(Vector3fcBinarySerializer)
        Cbf.registerSerializer(Vector4iBinarySerializer)
        Cbf.registerSerializer(Vector4icBinarySerializer)
        Cbf.registerSerializer(Vector4dBinarySerializer)
        Cbf.registerSerializer(Vector4dcBinarySerializer)
