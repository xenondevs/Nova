 ...
 * Defaults to `0`.
 * Used when `block_delay` is not specified in the config.
 *
 ...
 * Defaults to `1.0`.
 * Used when `disable_cooldown_scale` is not specified in the config.
 *
 * @param damageReductions A list of [DamageReductions][DamageReduction] of how much damage should be blocked on attack.
 * Defaults to none.
 * Used when `damage_reductions` is not specified in the config. 
 ...
 * Defaults to `null`.
 * Used when `bypassed_by` is not specified in the config.
 *
 ...
 * Defaults to `null`.
 * Used when `block_sound` is not specified in the config.
 *
 ...
 * Defaults to `null`.
 * Used when `disable_sound` is not specified in the config.
 */
fun Shield(
    blockDelay: Int = 0,
