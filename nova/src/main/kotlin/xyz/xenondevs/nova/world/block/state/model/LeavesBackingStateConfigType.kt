...
internal class SpruceLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class BirchLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class JungleLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class AcaciaLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class DarkOakLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class MangroveLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class CherryLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class AzaleaLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
...
internal class FloweringAzaleaLeavesBackingStateConfig(distance: Int, persistent: Boolean) : LeavesBackingStateConfig(Blocks.OAK_LEAVES, distance, persistent) {
