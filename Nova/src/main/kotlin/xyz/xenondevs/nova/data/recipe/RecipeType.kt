...
class RecipeType<T : Any> private constructor(
    ...
    companion object {
        ...
        val ELECTRIC_BREWING_STAND = RecipeType("electric_brewing_stand", ElectricBrewingStandRecipe::class, FluidInfuserRecipeGroup, ElectricBrewingStandRecipeDeserializer) // TODO: recipe group
